...
dc = dc.drop(columns=['Address', 'House direction', 'Balcony direction'
...
gia_du_doan = mlp_model.predict(Nha_vi_du_scaled)
...
plt.title(f"Biểu đồ dự đoán giá nhà bằng mô hình Neural Network\n$R^2$: {r2:.2f}")
...
# 22. Hiển thị các thông số mô hình
